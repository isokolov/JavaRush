...
public class Solution {
    ...
    /*public Item getProxy(Class ... clazz) {

        ItemInvocationHandler original = new ItemInvocationHandler();

        ClassLoader classLoader = this.getClass().getClassLoader();
        Class<?>[] interfaces = this.getClass().getInterfaces();
        Item invocationHandler = new ItemInvocationHandler() ;

        ItemInvocationHandler reader = (ItemInvocationHandler)Proxy.newProxyInstance(classLoader, interfaces, new ItemInvocationHandler());
