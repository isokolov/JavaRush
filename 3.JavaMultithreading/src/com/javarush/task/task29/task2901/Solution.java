...
public class Solution {
    public static final String DEFAULT_FILE_NAME = "C:/tmp/strange_file_name.tmp";  // DEFAULT_FILE_NAME

    private final String localFileName;
    private List<String> contentAsLines; // contentAslines
    ...
    public boolean isFileLoaded() { // getFileLoaded
        return fileLoaded;
    }

    public void downloadFileContent() { // DownloadFileContent()
        try {
